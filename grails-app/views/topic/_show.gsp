            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <g:hiddenField name="topicId" id="topicId${topic.id}" value="${topic.id}"/>
                       ...
                       <span class="row">
                        <button class="saveTopicNameButton1 btn-success" topicId="${topic.id}">Save</button>


                        <button class="cancelTopicNameButton1 btn-danger" topicId="${topic.id}">Cancel</button>
                           </span>
</span>
                    </div>
